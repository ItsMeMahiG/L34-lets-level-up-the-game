...
pygame.init()
pygame.mixer.init()
pygame.mixer.music.load("coin-collision-sound-342335.mp3")  # Your sound

# Load and transform the background image
background_image = pygame.transform.scale(
    pygame.image.load("bgg.jpg"), (SCREEN_WIDTH, SCREEN_HEIGHT)
)
...
class Sprite(pygame.sprite.Sprite):
    def __init__(self, color, height, width):
        ...
        self.image.fill(pygame.Color('dodgerblue'))  # Sprite background
...
while running:
    ...
    if not won:
        ...
        if sprite1.rect.colliderect(sprite2.rect):
            ...
            won = True
            pygame.mixer.music.play()  # Play sound once on collision
